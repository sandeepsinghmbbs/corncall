...
import 'package:corncall/features/auth/screens/login_screen.dart';
...
import 'package:corncall/features/status/screens/status_screen.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case OTPScreen.routeName:
      ...
      var verificationId = args['verificationId'].toString();
      var phoneNumber = args['phoneNumber'].toString();
